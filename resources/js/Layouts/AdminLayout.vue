                ...
                <ul class="space-y-2 tracking-wide mt-8">
                    ...
                    <li>
                        ...
                        >
                            ...
                            <span class="-mr-1 font-medium">Facilities</span>
                        </SidebarLink>
                    </li>
                    <li>
                        <SidebarLink
                            :href="route('hotels.index')"
                            :active="route().current('hotels.index')"
                        >
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                fill="none"
                            ...
                            <span class="-mr-1 font-medium">Отели</span>
                        </SidebarLink>
                    </li>
                    <li>
                        <SidebarLink
                        ...
                        >
                            ...
                            <span class="-mr-1 font-medium">Комнаты</span>
                        </SidebarLink>
                    </li>
                </ul>
            </div>
